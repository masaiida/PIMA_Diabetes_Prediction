...
Xtrain_path = "hf://datasets/masaiida/PIMA-Diabetes-Prediction/Xtrain.csv"                    # enter the Hugging Face username here
Xtest_path = "hf://datasets/masaiida/PIMA-Diabetes-Prediction/Xtest.csv"                      # enter the Hugging Face username here
ytrain_path = "hf://datasets/masaiida/PIMA-Diabetes-Prediction/ytrain.csv"                    # enter the Hugging Face username here
ytest_path = "hf://datasets/masaiida/PIMA-Diabetes-Prediction/ytest.csv"                      # enter the Hugging Face username here
...
repo_id = "masaiida/PIMA-Diabetes-Prediction"                                         # enter the Hugging Face username here
repo_type = "model"
